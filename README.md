...
&emsp;&emsp;语伴使用Spring Boot和uniapp进行开发，并利用vue3技术与vite项目包配置工具对项目进行业务开发以及项目管理，本文主要介绍项目前端开发的相关内容。  
&emsp;&emsp;[后端开发]: (https://github.com/KeepLjx/Mandarin-Mate-Server)
